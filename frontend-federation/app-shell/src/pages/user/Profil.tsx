...
import {
  Heart, Clock, Lock, Globe, HelpCircle, LogOut, ChevronRight, BookOpen,
} from "lucide-react";
import { bookById } from "../../lib/data";
import { BookCover, Button, Card, Modal } from "../../components/ui";
...
import { sendHelpToAdmin } from "../../lib/notificationsStore";

type Sheet = "wishlist" | "password" | "bantuan" | null;
...
export default function Profil() {
  ...
  function onMenu(key: string) {
    if (key === "wishlist") setSheet("wishlist");
            ...
            <div className="space-y-3">
              {lib.wishlist.map((id) => {
                ...
                return (
                  ...
                  >
                    <BookCover initials={b.initials} color={b.color} className="h-14 w-12 rounded-lg" textClass="text-sm" />
                    <div>
